...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lineEdit.setGeometry(QtCore.QRect(80, 100, 91, 21))
        self.lineEdit.setText("")
        self.lineEdit.setObjectName("lineEdit")
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(40, 100, 31, 17))
        ...
        self.pushButton_6.setGeometry(QtCore.QRect(40, 400, 171, 121))
        font = QtGui.QFont()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_2.setText(_translate("MainWindow", "All 1"))
        self.pushButton_3.setText(_translate("MainWindow", "All 0"))
        self.pushButton_4.setText(_translate("MainWindow", "Center"))
        self.pushButton_5.setText(_translate("MainWindow", "Border"))
        self.pushButton_6.setText(_translate("MainWindow", "Simulate"))
